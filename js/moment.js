...
;(function (global, factory) {
    ...
    function expandFormat(format, locale) {
        ...
        while (i >= 0 && localFormattingTokens.test(format)) {
            format = format.replace(
                localFormattingTokens, replaceLongDateFormatTokens
            );
        ...
        if (input != null) {
            ...
            if (offset !== input) {
                if (!keepLocalTime || this._changeInProgress) {
                    addSubtract(
                        this, createDuration(input - offset, 'm'), 1, false
                    );
    ...
    function isMomentInput(input) {
        return (
            ...
            isNumberOrStringArray(input) || isMomentInputObject(input) ||
    ...
    function toISOString(keepOffset) {
        ...
        return formatMoment(
            m, utc ? 'YYYY-MM-DD[T]HH:mm:ss.SSS[Z]' : 'YYYY-MM-DD[T]HH:mm:ss.SSSZ'
        );
    }
